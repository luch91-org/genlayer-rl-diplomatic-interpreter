...
CONFIG = {
    "repo_name": "genlayer-rl-diplomatic-interpreter",
    "contract_filename": "diplomatic_interpreter.py",
    "max_steps": 5,
    "domain": {
        "id": "interpreter",
        "name": "Diplomatic Interpreter",
        "plain_name": "Community Mediator",
        "plain_blurb": "drafts compromises to cool a community dispute",
        "world": "Cross-community mediation",
    },
    "contract": {
        "address": "0xA5cf174b2fDC77058C181435040121711312EE15",
        "chain": "studionet",
    },
    "prompt_fn": "build_judge_prompt",
    "prompt_sample": [
        "A concrete split of the parcel...",
        "public park",
        "housing",
        80,
    ],
    "capture_action": {"id": "draft_balanced", "label": "table the balanced compromise"},
    "rollout": {
        "env_seed": 0,
        "agent_seed": 0,
        "state_keys": ["polarization", "round", "num_proposals"],
    },
}
